...
CREATE TABLE IF NOT EXISTS `benchmark_fps_results` (
  ...
  UNIQUE KEY `uk_benchmark_fps` (`BENCHMARK_BUILD_ID`, `BENCHMARK_GAME_ID`, `RESOLUTION`, `OPTION_KEY`, `SOURCE_CONDITION_KEY`),
...
CREATE TABLE IF NOT EXISTS `benchmark_combo_game_results` (
  ...
  UNIQUE KEY `uk_benchmark_combo_game` (`COMBO_KEY`, `BENCHMARK_GAME_ID`, `RESOLUTION`, `OPTION_KEY`, `SOURCE_CONDITION_KEY`),
