...
-- games, performance_estimates 제거됨 (2026-09-03)
-- 게임 마스터는 benchmark_games 단일 테이블로 통합
-- game_requirements는 benchmark_games.BENCHMARK_GAME_ID 참조
...
CREATE TABLE IF NOT EXISTS `game_requirements` (
  ...
  UNIQUE KEY `uq_game_requirements_profile` (`BENCHMARK_GAME_ID`, `RESOLUTION`, `TARGET_FPS`, `QUALITY_PRESET`),
  KEY `idx_game_requirements_game`  (`BENCHMARK_GAME_ID`),
  KEY `idx_game_requirements_match` (`RESOLUTION`, `TARGET_FPS`, `QUALITY_PRESET`),
  CONSTRAINT `fk_game_requirements_benchmark_game`
